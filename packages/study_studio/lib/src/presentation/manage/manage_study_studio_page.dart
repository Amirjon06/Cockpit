...
class ManageStudyStudioPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ManageStudyStudioPage> createState() =>
      _ManageStudyStudioPageState();
}

class _ManageStudyStudioPageState extends ConsumerState<ManageStudyStudioPage> {
...
class _UploadMaterials extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      (Icons.picture_as_pdf_rounded, StudyPalette.danger, 'PDF'),
      (Icons.slideshow_rounded, StudyPalette.warning, 'Slides'),
      (Icons.description_rounded, StudyPalette.info, 'Word'),
      (Icons.image_rounded, StudyPalette.success, 'Image'),
      (Icons.graphic_eq_rounded, StudyPalette.violet, 'Audio'),
      (Icons.play_circle_rounded, StudyPalette.pink, 'Video'),
      (Icons.sticky_note_2_rounded, StudyPalette.amberBright, 'Notes'),
    ];
    ...
    return Column(
      children: [
              ...
              final file = Row(
                children: [
                  Container(
                    ...
                    height: 48,
                    decoration: BoxDecoration(
                      color: StudyPalette.danger.withValues(alpha: 0.12),
        ...
        Container(
          ...
          padding: const EdgeInsets.all(CockpitSpacing.sm),
          decoration: BoxDecoration(
            color: StudyPalette.success.withValues(alpha: 0.08),
            borderRadius: BorderRadius.circular(CockpitRadii.sm),
          ),
          child: const Row(
            mainAxisAlignment: MainAxisAlignment.center,
...
class _ExportShare extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      (Icons.note_rounded, StudyPalette.violet, 'Export Notes', 'PDF/MD'),
      (
        Icons.style_rounded,
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final button = Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [scheme.primary, StudyPalette.purple],
              ),
              borderRadius: BorderRadius.circular(CockpitRadii.md),
            ),
            child: FilledButton.icon(
